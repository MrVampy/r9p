...
pub struct FrontAbi {
    ...
    client_authentication: Mutex<Option<session::SessionAuthentication>>,
...
pub extern "C" fn r9p_front_new() -> *mut FrontAbi {
    Box::into_raw(Box::new(FrontAbi {
        ...
        client_authentication: Mutex::new(None),
...
#[no_mangle]
pub unsafe extern "C" fn r9p_front_register_snapshot_read_relay(
    handle: *mut FrontAbi,
    path: *const c_char,
    path_len: usize,
) -> i32 {
    ...
    match abi.front.register_snapshot_read_relay(path) {
        Ok(()) => {
            clear_last_error(abi);
            OK
        }
